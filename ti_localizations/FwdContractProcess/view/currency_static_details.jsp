...
<gr:textfield id="brnCode" name="staticDataVo.branchCode"
...
<div class="col-md-4 input-group input-group-md">
<gr:textfield id="branchFullName" name="staticDataVo.branchFullName"
										cssClass="form-control text_box">
</gr:textfield>
</div>
</div>
...
<tr class="branchList" ondblclick="selectBranch(this)">
...
<td style="padding: 4px 5px;">
<div class="form-group" align="left">
<gr:property value="branchFullName" />
<div class="col-md-8 input-group input-group-md"></div>
</div>
</td>
