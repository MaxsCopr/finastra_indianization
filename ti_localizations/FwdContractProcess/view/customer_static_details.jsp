...
<gr:textfield id="cusID" name="staticDataVo.customerID"
...
<div class="form-group">
<label class="col-md-5 Control-label"
									style="font-weight: normal;">Customer Name</label>
<div class="col-md-4 input-group input-group-md">
<gr:textfield id="cusName" name="staticDataVo.customerName"
										cssClass="form-control text_box">
</gr:textfield>
</div>
</div>
...
<div class="form-group">
								...
								<input type="button" value="Refresh" class="button"
									onclick="fetchCustomerStaticData()" />
...
<tr class="customerList"
														ondblclick="selectCustomerID(this)">
...
<td style="padding: 4px 5px;">
<div class="form-group" align="left">
<gr:property value="customerName" />
<div class="col-md-8 input-group input-group-md"></div>
</div>
</td>
<%-- <td style="padding:4px 5px;">
<div class="form-group" align="left">
<gr:property value="custCustomerNo"/>														
<div class="col-md-8 input-group input-group-md"></div>
</div>
</td>	 --%>
