...
<label class="col-md-5 Control-label"
									style="font-weight: normal;">Treasury Reference Number</label>
<div class="col-md-4 input-group input-group-md">
<gr:textfield id="treRef" name="staticDataVo.treasuryRefNo"
...
<tbody>
<tr>
<th align="left" style="width: 400px; padding: 4px 5px;">Treasury
													Reference Number</th>
<th align="left" style="width: 400px; padding: 4px 5px;">Customer
													ID</th>
<th align="left" style="width: 400px; padding: 4px 5px;">Booking
													Date</th>
<th align="left" style="width: 400px; padding: 4px 5px;">Deal
													Valid From Date</th>
<th align="left" style="width: 400px; padding: 4px 5px;">Deal
													Valid To Date</th>
</tr>
...
<tr class="treasuryList"
														ondblclick="selectTreasuryRefNumber(this)">
<td style="padding: 4px 5px;">
<div class="form-group" align="left">
<gr:property value="treasuryRefNo" />
...
<td style="padding: 4px 5px;">
<div class="form-group" align="left">
<gr:property value="bookingDate" />
<div class="col-md-8 input-group input-group-md"></div>
</div>
</td>
<td style="padding: 4px 5px;">
<div class="form-group" align="left">
<gr:property value="dealValidFromDate" />
<div class="col-md-8 input-group input-group-md"></div>
</div>
</td>
<td style="padding: 4px 5px;">
<div class="form-group" align="left">
<gr:property value="dealValidToDate" />
<div class="col-md-8 input-group input-group-md"></div>
</div>
</td>
</tr>
...
<gr:hidden id="dealValidFromDate"
						name="fwdContractVO.dealValidFromDate"></gr:hidden>
...
<gr:hidden id="dealValidToDate"
						name="fwdContractVO.dealValidToDate"></gr:hidden>
