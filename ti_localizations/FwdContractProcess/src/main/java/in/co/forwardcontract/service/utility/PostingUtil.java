    ...
    try
    {
      ...
      if (postingCount > 0)
      {
        for (int i = 0; i < postingCount; i++)
        {
          ...
          aPostingReqPartTrnRec.setSerialNum(serialNo);
          ...
          aPostingReqTranPart.setSERIAL_NUM(serialNo);
        ...
        aPostingReqCount.setCreditCount(creditCount);
        aPostingReqCount.setDebitCount(debitCount);
        aPostingReqCount.setTotalXferCount(creditCount + debitCount);
