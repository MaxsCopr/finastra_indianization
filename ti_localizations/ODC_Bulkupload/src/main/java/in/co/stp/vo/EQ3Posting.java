...
public class EQ3Posting
{
  ...
  private String Msg;
  private String portofloading_country;
  private String protofloading_description;
  private String drawee_address;
  private String chargeAccount;
  private String drawee_name;
  private String collecting_bank;
  private String amt_tobe_collected;
  private String remittance_currency;
  private String notional_rate;
  private String collecting_bank_addresss;
  private String usd_quivalent_amt;
  private String rate_in_usd;
  private String inr_quivalent;
  private String lob_code;
  private String advance_collection_amt;
  private String reason_short_shp_amt;
  private String short_shp_amt;
  private String portofDestinationCountry;
  private String portofDestinationDescription;
  ...
  private String record_indicator;
  ...
  public String getCollecting_bank_addresss()
  {
    return this.collecting_bank_addresss;
  }
 
  public void setCollecting_bank_addresss(String collecting_bank_addresss)
  {
    this.collecting_bank_addresss = collecting_bank_addresss;
  }
  ...
  public String getRemittance_currency()
  {
    return this.remittance_currency;
  }
 
  public void setRemittance_currency(String remittance_currency)
  {
    this.remittance_currency = remittance_currency;
  }
 
  public String getAmt_tobe_collected()
  {
    return this.amt_tobe_collected;
  }
 
  public void setAmt_tobe_collected(String amt_tobe_collected)
  {
    this.amt_tobe_collected = amt_tobe_collected;
  }
 
  public String getUsd_quivalent_amt()
  {
    return this.usd_quivalent_amt;
  }
 
  public void setUsd_quivalent_amt(String usd_quivalent_amt)
  {
    this.usd_quivalent_amt = usd_quivalent_amt;
  }
 
  public String getRate_in_usd()
  {
    return this.rate_in_usd;
  }
 
  public void setRate_in_usd(String rate_in_usd)
  {
    this.rate_in_usd = rate_in_usd;
  }
 
  public String getInr_quivalent()
  {
    return this.inr_quivalent;
  }
 
  public void setInr_quivalent(String inr_quivalent)
  {
    this.inr_quivalent = inr_quivalent;
  }
  ...
  public String getCollecting_bank()
  {
    return this.collecting_bank;
  }
 
  public void setCollecting_bank(String collecting_bank)
  {
    this.collecting_bank = collecting_bank;
  }
 
  public String getAdvance_collection_amt()
  {
    return this.advance_collection_amt;
  }
 
  public void setAdvance_collection_amt(String advance_collection_amt)
  {
    this.advance_collection_amt = advance_collection_amt;
  }
  ...
  public String getReason_short_shp_amt()
  {
    return this.reason_short_shp_amt;
  }
 
  public void setReason_short_shp_amt(String reason_short_shp_amt)
  {
    this.reason_short_shp_amt = reason_short_shp_amt;
  }
 
  public String getShort_shp_amt()
  {
    return this.short_shp_amt;
  }
 
  public void setShort_shp_amt(String short_shp_amt)
  {
    this.short_shp_amt = short_shp_amt;
  }
 
  public String getPortofDestinationCountry()
  {
    return this.portofDestinationCountry;
  }
 
  public void setPortofDestinationCountry(String portofDestinationCountry)
  {
    this.portofDestinationCountry = portofDestinationCountry;
  }
 
  public String getPortofDestinationDescription()
  {
    return this.portofDestinationDescription;
  }
 
  public void setPortofDestinationDescription(String portofDestinationDescription)
  {
    this.portofDestinationDescription = portofDestinationDescription;
  }
 
  public String getDrawee_address()
  {
    return this.drawee_address;
  }
 
  public void setDrawee_address(String drawee_address)
  {
    this.drawee_address = drawee_address;
  }
 
  public String getPortofloading_country()
  {
    return this.portofloading_country;
  }
 
  public void setPortofloading_country(String portofloading_country)
  {
    this.portofloading_country = portofloading_country;
  }
 
  public String getProtofloading_description()
  {
    return this.protofloading_description;
  }
 
  public void setProtofloading_description(String protofloading_description)
  {
    this.protofloading_description = protofloading_description;
  }
  ...
  public String toString()
  {
    return
      ...
      "EQ3Posting [status=" + this.status + ", theirref=" + this.theirref + ",behalfofbranch = " + this.behalfofbranch + ", " + " collectionamount = " + this.collectionamount + ",collectioncurrency = " + this.collectioncurrency + ", " + " shipmenttocountry = " + this.shipmenttocountry + ",\tshipmentfromcountry = " + this.shipmentfromcountry + ", " + " hscode = " + this.hscode + ",incoterms = " + this.incoterms + ",\tgoodscode = " + this.goodscode + ", " + " gooddescription = " + this.gooddescription + ",portofdestination = " + this.portofdestination + ",portofloading = " + this.portofloading + ", " + " transportdocno = " + this.transportdocno + ",transportdocdate = " + this.transportdocdate + ",invoiceno = " + this.invoiceno + ", " + " invoicedate = " + this.invoicedate + ",form_type = " + this.form_type + ",shpbill_no = " + this.shpbill_no + ",bill_date = " + this.bill_date + ", " + " port_code = " + this.port_code + ",\tform_no = " + this.form_no + ",\tshp_amt = " + this.shp_amt + ",\tshp_currency = " + this.shp_currency + ", " + " repamt_wrt_amt = " + this.repamt_wrt_amt + ",shortcollectionamount = " + this.shortcollectionamount + ", " + " reason_for_short_collection = " + this.record_indicator + ",leo_date = " + this.leo_date + ",\texport_agency = " + this.export_agency + ", " + "export_type = " + this.export_type + ",destination_countrry = " + this.destination_countrry + ",\tiecode = " + this.iecode + ", " + " adcode = " + this.adcode + ",customs_number = " + this.customs_number + ",shp_inv_sno = " + this.shp_inv_sno + ",shp_invoice_no = " + this.shp_invoice_no + ", " + "shp_invoice_date = " + this.shp_invoice_date + ",fob_amt = " + this.fob_amt + ",\tfreight_amt = " + this.freight_amt + ", " + " ins_amt = " + this.ins_amt + ",\tcomm_amt = " + this.comm_amt + ",discount_amt = " + this.discount_amt + ",deduction_amt = " + this.deduction_amt + ", " + " package_amt = " + this.package_amt + ",\tremittance_adcode = " + this.remittance_adcode + ",\tremittance_num = " + this.remittance_num + ", " + " firc_no = " + this.firc_no + ",remitter_name = " + this.remitter_name + ",remitter_date = " + this.remitter_date + ",remitter_country = " + this.remitter_country + ", " + " utilization_amount = " + this.utilization_amount + ", BatchId= " + this.BatchId + " ";
  }
 
  public String getRecord_indicator()
  {
    return this.record_indicator;
  }
 
  public void setRecord_indicator(String record_indicator)
  {
    this.record_indicator = record_indicator;
  }
