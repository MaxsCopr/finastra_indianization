...
<script>
	function portOfShipdetails1() {
		...
		$("#formId1").attr("action", "fetchPortCodeList");
		$("#formId1").submit();
	}
	function selectPort(event) {
		...
		$("#pos").val(value);
		$("#formId1").attr("action", "portOfShipmentToBOE");
		$("#formId1").submit();
	}
	function fnClose(){
...
<li style="text-align: center;"><a href="#" onclick="fnClose()">Close</a></li>
</ul>
</div>
<br/>
<!-- <div class="side_nav">
...
<boe:textfield id="countryName" name="boeVO.countryName"
												cssClass="form-control text_box" onblur = "disableRefresh()">
</boe:textfield>
</div>
</div>
</div>
<div class="col-md-2">
<div class="form-group">
<input type="button" value="Refresh" class="button" id="refreshBtn"
...
<boe:hidden id="remarks" name="boeVO.remarks"></boe:hidden>
