...
<gr:textfield id="goodsCode" name="cusDataVo.goodsCode" 
...
<div class="form-group">
<label class="col-md-5 Control-label"
											style="font-weight: normal;">Goods Desc </label>
<div class="col-md-4 input-group input-group-md">
<gr:textfield id="goodsDesc" name="cusDataVo.goodsDesc" 
												cssClass="form-control text_box">
</gr:textfield>
</div>
</div>
...
<span></span>
<h5 style="font-weight: bold; font-size: 13px; color:#527BB8;">&nbsp;<gr:text name="Goods Code Details" /></h5>
</div>
<div class="form-group">
<!-- <div class="table"> -->
...
<tbody>
<tr>
<th align="left" style="width:600px; padding:4px 5px;">Code</th>
<th align="left" style="width:600px; padding:4px 5px;">Description</th>
...
<gr:iterator value="goodsList" id="goodsList" status="list" >
<tr class="goodslist" ondblclick="selectGoodsCode(this)">
<td style="padding:4px 5px;">
<div class="form-group" align="left">
<gr:property value="goods"/>
...
<gr:hidden id="dueDate" name="chargeVO.dueDate"/>
</div>
</div>
</div>
</gr:form>
