...
<head>
<title>Inward Documentary Credit List</title>
...
<label class="col-md-5 Control-label"
											style="font-weight: normal;"> Master </label>
<div class="col-md-4 input-group input-group-md">
<gr:textfield id="master" name="cusDataVo.master" 
...
<div class="col-md-4 input-group input-group-md">
<gr:textfield id="custNo" name="cusDataVo.custNo" 
												cssClass="form-control text_box">
</gr:textfield>
</div>
</div>
...
<span></span>
<h5 style="font-weight: bold; font-size: 13px; color:#527BB8;">&nbsp;<gr:text name="Inward Documentary Credit Details" /></h5>
</div>
<div class="form-group">
<!-- <div class="table"> -->
...
<tbody>
<tr>
<th align="left" style="width:200px; padding:4px 5px;">Master</th>
<th align="left" style="width:200px; padding:4px 5px;">Customer</th>
<th align="left" style="width:200px; padding:4px 5px;">Importer</th>
<th align="left" style="width:200px; padding:4px 5px;">Amount</th>
<th align="left" style="width:200px; padding:4px 5px;">Currency</th>
</tr>											    
<c:if test="${empty inwardDocList}">
<tr>
<td colspan="10">No records found</td>
</tr>
</c:if>
<c:if test="${not empty inwardDocList}">
<gr:iterator value="inwardDocList" id="inwardDocList" status="list" >
<tr class="inwardDocList" ondblclick="selectInwardDetails(this)">
<td style="padding:4px 5px;">
<div class="form-group" align="left">
<gr:property value="masRef"/>
...
<td style="padding:4px 5px;">
<div class="form-group" align="left">
<gr:property value="cif"/>														
<div class="col-md-8 input-group input-group-md"></div>
</div>
</td>
<td style="padding:4px 5px;">
<div class="form-group" align="left">
<gr:property value="impName"/>														
<div class="col-md-8 input-group input-group-md"></div>
</div>
</td>
<td style="padding:4px 5px;">
<div class="form-group" align="left">
<gr:property value="masAmount"/>														
<div class="col-md-8 input-group input-group-md"></div>
</div>
</td>
<td style="padding:4px 5px;">
<div class="form-group" align="left">
<gr:property value="masCcy"/>														
<div class="col-md-8 input-group input-group-md"></div>
</div>
</td>
...
<div>		<gr:hidden name="chargeVO.exportOrderNumber"></gr:hidden>
<gr:hidden name="chargeVO.CifID"></gr:hidden>
<gr:hidden name="chargeVO.exporterOrderDate" id="datepicker2"></gr:hidden>
<%-- <gr:hidden name="chargeVO.incoTerms"></gr:hidden> --%>
<gr:hidden name="chargeVO.poValue"></gr:hidden>
<gr:hidden name="chargeVO.goodsCode" id ="goodsCode"></gr:hidden>
<gr:hidden name="chargeVO.exportcurrency"></gr:hidden>
<gr:hidden name="chargeVO.exportexpiryDate" id="exportexpiryDate"></gr:hidden>
<gr:hidden name="chargeVO.freightDeduction"></gr:hidden>
<gr:hidden name="chargeVO.lastShipmentDate" id="lastShipmentDate"></gr:hidden>
...
<gr:hidden id="cifCodeID" name="chargeVO.incoTerms"></gr:hidden>
<gr:hidden  name="chargeVO.beneficiaryName"></gr:hidden>
...
<gr:hidden id="refNo" name="chargeVO.importerName"/>
