...
<!-- <img src="images/finastra-logo.png.png" /> -->
<img src="images/finastra-logo.png.png" alt="Red ball" style="padding-top: -6px;WIDTH: 1365px;height: 60px;margin-left: -15px;margin-top: -10px;">
</div>
