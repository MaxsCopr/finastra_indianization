...

{
  ...
  private String chPayStatus;

  public String getChPayStatus()

  {

    return this.chPayStatus;

  }

  public void setChPayStatus(String chPayStatus)
  ...
  public String getUniqueSeqNo()

  {

    return this.uniqueSeqNo;

  }

  public void setUniqueSeqNo(String uniqueSeqNo)

  {

    this.uniqueSeqNo = uniqueSeqNo;
