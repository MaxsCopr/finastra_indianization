...

{
  ...
  public String getPayStatusAmd()

  {

    return this.payStatusAmd;

  }

  public void setPayStatusAmd(String payStatusAmd)
  ...
  public String getRemAdcode()

  {

    return this.remAdcode;

  }

  public void setRemAdcode(String remAdcode)

  {

    this.remAdcode = remAdcode;
  ...
  public int getNoShipBillNo()

  {

    return this.noShipBillNo;

  }

  public void setNoShipBillNo(int noShipBillNo)

  {

    this.noShipBillNo = noShipBillNo;
