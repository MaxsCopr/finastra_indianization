  ...
  implements PreparedStatement
{
  ...
  public boolean isWrapperFor(Class<?> paramClass)
    throws SQLException
  {
    throw new Error("Unresolved compilation problem: \n\tThe method isWrapperFor(Class<?>) of type LoggableStatement must override a superclass method\n");
  }
 
  public <T> T unwrap(Class<T> paramClass)
    throws SQLException
  {
    throw new Error("Unresolved compilation problem: \n\tThe method unwrap(Class<T>) of type LoggableStatement must override a superclass method\n");
  }
 
  public void closeOnCompletion()
    throws SQLException
  {
    throw new Error("Unresolved compilation problem: \n\tThe method closeOnCompletion() of type LoggableStatement must override a superclass method\n");
  }
 
  public boolean isCloseOnCompletion()
    throws SQLException
  {
    throw new Error("Unresolved compilation problem: \n\tThe method isCloseOnCompletion() of type LoggableStatement must override a superclass method\n");
  }
}
