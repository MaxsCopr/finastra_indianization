...
<h5 class="row fontcol" style="color: #527BB8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Merchant Trade
</h5>
...
<% 
					String accessFlg="";
					accessFlg = (String)session.getAttribute("accessFlg");
					System.out.println("accessFlg ==>" + accessFlg);
						if(accessFlg =="true") {%>
<div class="btn btn-link" id="makerProcess">
<a href="makerProcess">MTT AMEND MAKER PROCESS</a>
</div>
<br />
<div class="btn btn-link" id="checkerProcess">
<a href="checkerProcess">MTT AMEND CHECKER PROCESS</a>
</div>
<br />
<div class="btn btn-link" id="enquiryProcess">
<a href="enquiryProcess">MTT ENQUIRY</a>
</div>
<br />
<div class="btn btn-link" id="stagingProcess">
<a href="stagingProcess">MTT STAGING</a>
</div>
<br />
<div class="btn btn-link" id="reportsProcess">
<a href="reportsProcess">MTT REPORTS</a>
</div>
<br />
<%} else {%> 
<!-- <div class="btn btn-link" id="makerProcess">
