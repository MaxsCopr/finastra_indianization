...
<h5 class="row fontcol" style="color: #527BB8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CHECKER PROCESS
</h5>
<div id="userIdMessage"></div>
<div class="row cont_colaps">
<div class="col-md-12">
<div class="btn btn-link" id="GR_Process">
<a href="mttstatusCheckerProcess">MTT STATUS AMEND</a>
</div>
<br />
<div class="btn btn-link" id="GR_Process">
<a href="mttNumberCheckerProcess">MTT NUMBER AMEND</a>
</div>
<br />
<div class="btn btn-link" id="GR_Process">
<a href="mttNumberSplitCheckerProcess">MTT NUMBER SPLIT </a>
</div>
<br />
