...
public abstract interface ActionConstants
{
  ...
  public static final Map<String, String> SUBPRODUCT = Collections.unmodifiableMap(new HashMap<String, String>());
  public static final Map<String, String> STATUSLIST = Collections.unmodifiableMap(new HashMap<String, String>());
}
