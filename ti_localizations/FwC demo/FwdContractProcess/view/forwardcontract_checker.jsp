...
<title>Forward Contract Checker</title>
...
      function fetchCheckerFwdcontractDetails() {
            onChangeLoad();
            $("#myForm").attr("action", "fetchCheckerFwdcontractDetails");
            $("#myForm").submit();
      }
</script>
...
                              Forward Contract - Checker Process</h5>
                        <br /> <br />
...
                                                      <div class="col-md-3 input-group input-group-md">
                                                            <boe:select id="checkerStatus" list="statusList"
...
                                                            class="button" onclick="fetchCheckerFwdcontractDetails()" />
                                                </div>
...
                                                                                                      <div class="form-group">
                                                                                                            <c:choose>
                                                                                                                  <c:when test="${status=='PENDING FOR APPROVAL'}">
                                                                                                                        <input type="button" class="viewButton" value="View"
                                                                                                                              style="width: 50px; margin: 5px" />
                                                                                                                        <input type="button" class="ApproveOrRejectButton"
...
                                                            value="CheckerScreen"></boe:hidden>
                                                </div>
                                          </div>
                                    </div>
                              </div>
