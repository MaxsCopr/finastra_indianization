...
<title>IRM Extension Checker Page</title>
<jsp:include page="/view/common/header.jsp" />
<script type="text/javascript" src="js/checker/irmExtensionChecker.js"></script> 
<!--[if IE 7]>
...
<div class="col-md-10 content_box">
		...
		<h5 class="row fontcol">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;IRM Extension Checker Screen</h5>
...
<firc:textfield id="serialNo" name="irmExVO.transactionrefno"
...
<div class="page_collapsible" id="body-section1">
<span></span>
<h5 style="font-weight: bold; font-size: 13px;">&nbsp;IRM Extension Checker</h5>
</div>
<div class="form-group">
...
<tbody>
<tr>
<th style="text-align: left; width:150px; padding:4px 5px;"><label >Transaction Ref No</label></th>
...
<th style="text-align: left; width:150px; padding:4px 5px;"><label >Reason For Extension</label></th>
<th style="text-align: left; width:100px; padding:4px 5px;"><label>Status</label></th>											 
</tr>
<c:if test="${empty extensionList}">
<tr>
<td colspan="10">No records found</td>
</tr>
</c:if>
<c:if test="${not empty extensionList}">
<firc:iterator value="extensionList" id="extensionList">
<tr>
...
<td style="padding:4px 5px;">
<div class="form-group" align="left">
<firc:property value="extensionInd"/>														
<div class="col-md-8 input-group input-group-md"></div>
</div>
</td>						
<td style="padding:4px 5px;">
<div class="form-group" align="left">
<firc:property value="extensionDate"/>	
<div class="col-md-8 input-group input-group-md"></div>
</div>
...
<firc:checkbox name="chkList"
																fieldValue="%{#extensionList.tempTransRefNo}"
																disabled="%{#extensionList.checkBoxDisabled}">
</firc:checkbox>
<div class="col-md-8 input-group input-group-md"></div>
</div>
</td>						
...
<firc:hidden id="check" name="check"></firc:hidden>
</div>
</div>
</div>
</div>
