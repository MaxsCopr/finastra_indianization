...
<div class="col-md-12">
<div id="GR_Head"><div class="btn btn-link" onclick="GRCollapsePane()">FIRC Checker Process</div><br/>
<div id="GR_List" class="col-md-12" style="display:block;">
<div class="btn btn-link" id="GR_Process"><a href="checkerAction">FIRC Issuance Checker</a></div><br/>
<div class="btn btn-link" id="GR_Process"><a href="irmExtensionChecker">IRM Extension Checker</a></div><br/>	
<div class="btn btn-link" id="GR_Process"><a href="irmClosureChecker">IRM Adjustment/Closure Checker</a></div><br/>	
<firc:if test="%{#session.count == 1}">	
