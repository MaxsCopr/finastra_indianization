...
                                          $("#form1").attr("action", "fircIssuanceSearchBulk");
                                          $("#form1").submit();
                                    });
...
                                          
                                       $("#errorMessage").html("Only Approved transactions will be downloaded. Do you want to Download FIRA ? ");
                                          
...
                                                    'Yes': function() {
                                                       $(this).dialog('close');
                                                       $("#form1").attr("action", "firaPrintActionBulk");
                                                                   $("#form1").submit();
                                                     },
                                                     'No': function() {
                                                       $(this).dialog('close');
...
                                                      
                                                  console.log(value);
                                                      $("#form1").attr("action", "fircPrintAdviceActionBulk");
                                                      $("#form1").submit();
                                                 }
                                    
                                  } else {  
                                      
                                     alert('Please enter the CRN and select the corresponding Records')  ;
                                           }
                                    });
                                    
                                    $("#print")
...
                                                                                                                                    "#errorMessage")
                                                                                                                                    .html(
                                                                                                                                                "Do you want Duplicate/Re-issue Download ? ");
...
                                                                              $("#errorMessage")
                                                                                          .html(
                                                                                                      "Transaction has not been approved.So you could not print this document");
...
                                                                                    $("#errorMessage")
                                                                                                .html(
                                                                                                            "This transaction type is FIRC.So you could not send this document ");
...
                                                                              $("#errorMessage")
                                                                                          .html(
                                                                                                      "Transaction is not approved.So you could not print the document");
...
             var value = $("input[type='checkbox']").val(); 
              console.log(value);
                  $("#form1").attr("action", "fircDownloadBulk");
                  $("#form1").submit();
            }
      function customerCifCode() {
            $("#form1").attr("action", "customerCifCode");
            $("#form1").submit();
      }
      function checkedAll() {
...
                        <div class="side_nav">
                              <ul class="nav nav-pills nav-stacked">
                                    <!-- <li style="text-align: center;"><a href="#" id="print">Print(FIRC/FIRA)</a></li> -->
                                    <li style="text-align: center;"><a href="#" id="reprint">Send
                                                Advice(FIRA)</a></li>
                                    <li style="text-align: center;"><a href="#" id="reset">Reset</a></li>
                                    <li style="text-align: center;"><a href="#" id="download">Download</a></li>
                              </ul>
                        </div>
                        <br />
...
                                                            style="float: left;">
                                                            <firc:textfield id="dateFrom" name="issuanceVO.dataFrom"
...
                                                            <firc:textfield id="dateTo" name="issuanceVO.dataTo"
                                                                  readonly="true" cssClass="datepicker1 form-control text_box" />
                                                      </div>
...
                                                      <div class="col-md-4 input-group input-group-md">
                                                            <firc:select list="transStatus" name="issuanceVO.status"
                                                                  id="status" headerValue="<----->" headerKey=""
...
                                                <div class="form-group">
                                                      <label class="col-md-4 Control-label"
                                                            style="font-weight: normal;">CRN <span onclick="customerCifCode()"><img
                                                                        src="images/magnify.png" width="13%" height="13%" /></span></label>
                                                            
                                                            
                                                      <div class="col-md-4 input-group input-group-md">
                                                            <firc:textfield id="crn" name="issuanceVO.CRN"
                                                                  cssClass="form-control text_box" />
                                                      </div>
                                                </div>
...
                                                <div class="page_collapsible" id="body-section1">
                                                      <span></span>
                                                      <h5 style="font-weight: bold; font-size: 13px;">&nbsp;FIRC
                                                            Issuance</h5>
                                                </div>
                                                <div class="form-group">
                                                      <div id="selectrow"
...
                                                                        <tr>
                                                                           <th
                                                                                    style="text-align: left; width: 100px; padding: 4px 5px;"><label>Select</label>
                                                                                    <div class="form-group">
                                                                                                <%--  <firc:checkbox name="chkList" id="select_all">
                                                                                                      </firc:checkbox>
 --%>                                                                                                 
                                                                                           <firc:checkbox name="subscription_month" id="subscription_month" onclick="checkedAll.call(this);"/>
                                                                                          <div class="col-md-8 input-group input-group-md"></div>
                                                                                                </div></th>
                                                                        
                                                                              <th
                                                                                    style="text-align: left; width: 100px; padding: 4px 5px;"><label>Issuing
                                                                                          Bank</label></th>

                                                                              <th
                                                                                    style="text-align: left; width: 100px; padding: 4px 5px;"><label>Issuing
                                                                                          Bank Branch</label></th>

                                                                              <th
                                                                                    style="text-align: left; width: 100px; padding: 4px 5px;"><label>Master
                                                                                          Reference No</label></th>

                                                                              <th
                                                                                    style="text-align: left; width: 100px; padding: 4px 5px;"><label>FIRC
                                                                                          Serial No</label></th>
...
                                                                              <th
                                                                                    style="text-align: left; width: 100px; padding: 4px 5px;"><label>Beneficiary
                                                                                          Address</label></th>

                                                                              <th
                                                                                    style="text-align: left; width: 100px; padding: 4px 5px;"><label>Purpose
                                                                                          Code</label></th>

                                                                              <th
                                                                                    style="text-align: left; width: 100px; padding: 4px 5px;"><label>Order
                                                                                          Customer</label></th>
                                                                                          
                                                                              <th
                                                                                    style="text-align: left; width: 100px; padding: 4px 5px;"><label>CIF No</label></th>

                                                                              <th
                                                                                    style="text-align: left; width: 100px; padding: 4px 5px;"><label>Amount</label></th>

                                                                              <th
                                                                                    style="text-align: left; width: 100px; padding: 4px 5px;"><label>Currency</label></th>

                                                                              <th
                                                                                    style="text-align: left; width: 100px; padding: 4px 5px;"><label>EX
                                                                                          Rate</label></th>

                                                                              <th
                                                                                    style="text-align: left; width: 100px; padding: 4px 5px;"><label>Available
                                                                                          Amount</label></th>

                                                                              <th
                                                                                    style="text-align: left; width: 100px; padding: 4px 5px;"><label>Paid
                                                                                          Currency</label></th>
...
                                                                              <th
                                                                                    style="text-align: left; width: 100px; padding: 4px 5px;"><label>IRM
                                                                                          Type</label></th>

                                                                              <th
                                                                                    style="text-align: left; width: 100px; padding: 4px 5px;"><label>Remarks</label></th>

                                                                              <th
                                                                                    style="text-align: left; width: 100px; padding: 4px 5px;"><label>Status</label></th>
                                                                                    
                                                                                    
                                                                        </tr>
...
                                                                                                            fieldValue="%{#issuanceList.transrefno}">
                                                                                                      </firc:checkbox>
                                                                                                      <div class="col-md-8 input-group input-group-md"></div>
                                                                                                </div>
                                                                                                </td>
...
                                                                                          </td>
                                                                                          <td style="padding: 4px 5px;">
                                                                                                <div class="form-group" align="left" id="status">
...
                                                                  </tbody>
                                                            </table>
                                                            <br /> <br /> <input type="hidden" id="fircVal"
                                                                  name="fircValue" />
                                                                  <firc:hidden id="Checked" name="issuanceVO.checked"></firc:hidden>
                                                      </div>
                                                </div>
                                                <firc:hidden id="Checked" name="issuanceVO.checked"></firc:hidden>
