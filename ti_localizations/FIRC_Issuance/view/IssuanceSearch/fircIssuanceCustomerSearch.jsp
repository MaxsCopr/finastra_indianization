...
<gr:form method="post" id="form1" name="form">
<div class="row">
<div class="col-md-2">
<div class="side_nav" style="width: 200px;">
<ul class="nav nav-pills nav-stacked">
<li style="text-align: center;"><a href="bulk">Close</a></li>
</ul>
</div>
<br />
</div>
...
<div>
<gr:hidden id="cifCodeID" name="issuanceVO.CifID"></gr:hidden>
<gr:hidden id="customerName" name="issuanceVO.beneficiaryName"></gr:hidden>
</div>
</div>
</div>
</gr:form>
