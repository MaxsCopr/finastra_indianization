...
<div class="col-md-12">
<div id="GR_Head"><div class="btn btn-link" onclick="GRCollapsePane()">FIRC Process</div><br/>
<div id="GR_List" class="col-md-12" style="display:block;">
<div class="btn btn-link" id="GR_Process"><a href="makerProcess">FIRC Maker Process</a></div><br/>
<div class="btn btn-link" id="GR_Process"><a href="checkerProcess">FIRC Checker Process</a></div><br/>
<firc:if test="%{#session.count == 2}">	 
