...
{
  private static Logger logger = LogManager.getLogger(Checkking_Valid_User.class.getName());
    ...
    throws Exception
  {
    ...
    try
    {
      ...
      String Check_Valid_User = "SELECT * FROM TIGLOBAL.SS_USER WHERE USERNAME=?";
